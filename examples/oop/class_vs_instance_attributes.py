...
# %% md
# So class attributes and isntance attributes can have different values. We can
# find out attributes of ``class`` of an ``instance`` from the `instance` using following clode
